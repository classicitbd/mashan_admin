...
const AllReSellerPage = () => {
  ...
  const [reseller_request_status, setWholeseller_request_status] =
    useState("approved");
  const {
    data: reSellerApprovedData,
    isLoading,
    refetch,
  } = useQuery({
    queryKey: [
  ...
  console.log(reSellerApprovedData);
  ...
  return (
    <div className="py-6 px-1">
      ...
      <ReSellerTable
        reSellerApprovedData={reSellerApprovedData?.data}
        totalData={reSellerApprovedData?.totalData}
        refetch={refetch}
        limit={limit}
        page={page}
        setPage={setPage}
...
export default AllReSellerPage;
