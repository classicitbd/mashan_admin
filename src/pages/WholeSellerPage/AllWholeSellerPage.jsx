...
import WholeSellerTable from "../../components/WholeSellers/WholeSellerTable";
import { AuthContext } from "../../context/AuthProvider";
import useDebounced from "../../hooks/useDebounced";
import { BASE_URL } from "../../utils/baseURL";
const AllWholeSellerPage = () => {
  ...
  console.log(wholeSellerApprovedData);
  ...
  return (
    <div className="py-6 px-1">
      ...
      <WholeSellerTable
        wholeSellerApprovedData={wholeSellerApprovedData?.data}
        totalData={wholeSellerApprovedData?.totalData}
        refetch={refetch}
        limit={limit}
        page={page}
        setPage={setPage}
...
export default AllWholeSellerPage;
