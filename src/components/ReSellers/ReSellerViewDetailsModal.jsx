...
const ReSellerViewDetailsModal = ({
  reSellaerData,
  setIsViewModalOpen,
  user,
}) => {
  ...
  console.log("reseller_details", comment);
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/50 p-4">
      <div className="bg-white rounded-xl p-6 w-full max-w-2xl shadow-lg">
        ...
        <div className="flex justify-end space-x-3">
          ...
          >
            {updateReSellerStatus.isLoading ? "Updating..." : "Update"}
          </button>
        </div>
      </div>
    </div>
...
export default ReSellerViewDetailsModal;
