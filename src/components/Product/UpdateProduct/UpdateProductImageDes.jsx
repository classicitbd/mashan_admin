                  ...
                  >
                    ...
                    <input
                      ...
                      {...register("other_images", {
                        validate: {
                          isImage: (files) => {
                            if (!files) return true; // no files to validate yet
                            Array.from(files).every((file) =>
                              [
                                "image/jpg",
                                "image/jpeg",
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8 mt-4">
          ...
          <div className=" space-y-2 ">
            ...
            <Select
              ...
              defaultValue={
                trending_product == true || trending_product == "true"
          ...
          <div className="">
            ...
            <input
              ...
              id="product_warrenty"
              defaultValue={productData?.product_warrenty || ""}
              type="text"
          ...
          <div className="">
            ...
            <input
              ...
              id="product_return"
              defaultValue={productData?.product_return || ""}
              type="text"
...
export default UpdateProductImageDes;
