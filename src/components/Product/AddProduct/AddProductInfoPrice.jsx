const AddProductInfoPrice = ({ productInfoData, register, errors }) => {
  return (
    <section className=" shadow-md bg-gray-50 rounded-lg p-4 sm:p-8 md:p-12 mt-4">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_price}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_discount_price}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_buying_price}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_quantity}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_reseller_price}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_wholeseller_price}
        ...
        <div className="">
          ...
          <input
            defaultValue={productInfoData?.product_wholeseller_min_quantity}
...
export default AddProductInfoPrice;
