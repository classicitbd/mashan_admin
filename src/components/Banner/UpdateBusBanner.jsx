...
const UpdateBusBanner = ({
  setShowBusBannerUpdateModal,
  getBusBannerUpdateData,
  refetch,
}) => {
  ...
  const [imagePreview, setImagePreview] = useState(
    getBusBannerUpdateData?.banner_image
  );
  ...
  const handleDataPost = async (data) => {
    if (data?.banner_image) {
      ...
      formData.append(
        "banner_image_key",
        getBusBannerUpdateData?.banner_image_key
      );
      formData.append("_id", getBusBannerUpdateData?._id);
      ...
      if (result?.statusCode === 200 && result?.success === true) {
        ...
        refetch();
        setLoading(false);
        setShowBusBannerUpdateModal(false);
      } else {
      ...
      setLoading(true);
      const sendData = {
        _id: getBusBannerUpdateData?._id,
        banner_serial:
          data?.banner_serial || getBusBannerUpdateData?.banner_serial,
        banner_path: data?.banner_path || getBusBannerUpdateData?.banner_path,
        banner_status:
          data?.banner_status || getBusBannerUpdateData?.banner_status,
        banner_image_key: getBusBannerUpdateData?.banner_image_key,
      };
      const response = await fetch(`${BASE_URL}/banner`, {
        method: "PATCH",
        credentials: "include",
          ...
          <div className="relative overflow-hidden text-left bg-white rounded-lg shadow-xl w-[650px] p-6 max-h-[100vh] overflow-y-auto scrollbar-thin uppercase">
            <div className="flex items-center justify-between mt-4">
              ...
              <button
                ...
                onClick={() => setShowBusBannerUpdateModal(false)}
              >
                {" "}
            ...
            <form onSubmit={handleSubmit(handleDataPost)} className="">
              <div>
                ...
                <input
                  ...
                  defaultValue={getBusBannerUpdateData?.banner_path}
                  type="text"
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    defaultValue={getBusBannerUpdateData?.banner_status}
                ...
                <div>
                  ...
                  <input
                    ...
                    defaultValue={getBusBannerUpdateData?.banner_serial}
...
export default UpdateBusBanner;
