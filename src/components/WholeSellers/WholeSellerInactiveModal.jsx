...
const WholeSellerInactiveModal = ({
  wholeSellaerData,
  ...
  useEffect(() => {
    if (wholeSellaerData?.wholeseller_details) {
      setComment(wholeSellaerData.wholeseller_details);
    }
  }, [wholeSellaerData]);
  ...
  const handleStatusSubmit = () => {
    const requestData = {
      ...
      wholeseller_request_status: "approved",
      wholeseller_status: status === "active" ? "active" : "in-active",
...
export default WholeSellerInactiveModal;
